...
public class DingTalkEncryptor {
    ...
    private byte[]         aesKey;
    private String         token ;//设置默认的token
    ...
    private static final Logger LOGGER=LoggerFactory.getLogger(DingTalkEncryptor.class);
    /**
     * 构造函数
    ...
    public String getDecryptMsg(String msgSignature, String timeStamp, String nonce, String encryptMsg)throws DingTalkEncryptException {
    	...
    	LOGGER.info("############  密文解密  token ={"+token+"},\t timeStamp ={"+timeStamp+"},\t nonce ={"+nonce+"},\t encryptMsg ={"+encryptMsg+"},\t");
    	//校验签名
		...
		public static void main(String[] args) throws DingTalkEncryptException {
			 //token =0123456789,	 timeStamp =1504233051731,	 nonce =qpGeJULW,	 encryptMsg =Q2tz97pcLuVdocQSh0emuhj3Jr0ez6Klt6ccmHwa4x2nwYG5fpvs9AK63tBBCGQugf9Yd5rDlEouuUbdfgVMefx/tVxNUA9TlACeb5EPGQieUjxP3is+kZin0dQPVw0U,	
			 DingTalkEncryptor result = new DingTalkEncryptor(DingTalkConstant.TOKEN, DingTalkConstant.ENCODING_AES_KEY,DingTalkConstant.DING_TALK_CORP_ID);
			 String test= result.decrypt("Q2tz97pcLuVdocQSh0emuhj3Jr0ez6Klt6ccmHwa4x2nwYG5fpvs9AK63tBBCGQugf9Yd5rDlEouuUbdfgVMefx/tVxNUA9TlACeb5EPGQieUjxP3is+kZin0dQPVw0U");
